    ...
    try {
        ...
        if (in_array($lastPart, [
            ...
            switch($lastPart) {
                ...
                case 'contracts':
                    $query = "SELECT c.*, e.name as employee_name, ct.name as contract_type_name 
                             FROM contracts c 
                ...
                case 'leaves':
                    $query = "SELECT l.*, e.name as employee_name, lt.name as leave_type_name 
                             FROM leaves l 
                ...
                case 'assets':
                    $query = "SELECT a.*, e.name as assigned_to_name 
                             FROM assets a 
                ...
                case 'benefits':
                    $query = "SELECT b.*, e.name as employee_name 
                             FROM benefits b 
                ...
                case 'documents':
                    $query = "SELECT d.*, e.name as uploaded_by_name 
                             FROM documents d 
                ...
                case 'kpi':
                    $query = "SELECT k.*, e.name as employee_name 
                             FROM kpi k 
                ...
                case 'payroll':
                    $query = "SELECT p.*, e.name as employee_name 
                             FROM payroll p 
                ...
                case 'projects':
                    $query = "SELECT p.*, e.name as manager_name 
                             FROM projects p 
                ...
                case 'training_courses':
                    $query = "SELECT t.*, e.name as instructor_name 
