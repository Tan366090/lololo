        ...
        <main class="main-content">
            ...
            <div class="dashboard-cards">
                ...
                <div class="dashboard-card" id="expiredLeavesCard">
                    ...
                    <div class="leave-tooltip">
                        <div class="leave-tooltip-title">Chi tiết đơn quá hạn</div>
                        <div class="leave-tooltip-content">
                            <div class="leave-tooltip-item">
                                <i class="fas fa-calendar-times"></i>
                                <span id="expiredToday">0 đơn hôm nay</span>
                            </div>
                            <div class="leave-tooltip-item">
                                <i class="fas fa-calendar-times"></i>
                                <span id="expiredThisWeek">0 đơn tuần này</span>
                            </div>
                            <div class="leave-tooltip-item">
                                <i class="fas fa-calendar-times"></i>
                                <span id="expiredThisMonth">0 đơn tháng này</span>
                            </div>
                        </div>
                    </div>
                </div>
